    ...
    <section id="pricing" className="py-24 px-4 text-center bg-[#0e0e0e] text-white">
      ...
      <div className="flex justify-center gap-10 flex-wrap max-w-6xl mx-auto">
        ...
        <div className="border border-white p-8 rounded-xl w-80 shadow-lg bg-[#111]">
          ...
          <span className="block text-xl font-semibold mb-6">350$<span className="text-base font-normal">/One Time</span></span>
        ...
        <div className="border border-white p-8 rounded-xl w-80 shadow-lg bg-[#111]">
          ...
          <span className="block text-xl font-semibold mb-6">700$<span className="text-base font-normal">/One Time</span></span>
        ...
        <div className="border border-white p-8 rounded-xl w-80 shadow-lg bg-[#111]">
          ...
          <span className="block text-xl font-semibold mb-6">1500$<span className="text-base font-normal">/One Time</span></span>
